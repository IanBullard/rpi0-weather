...
void WeatherApp::render_weather(const WeatherData& data) {
    ...
    renderer_->draw_text_centered(PANELS[1].x, PANELS[1].y, PANEL_WIDTH, 32, "Currently", DisplayRenderer::BLACK);
    // Value area: remaining space below title
    renderer_->draw_text_centered(PANELS[1].x, PANELS[1].y + 32, PANEL_WIDTH, PANEL_HEIGHT - 32, temp_str, DisplayRenderer::BLACK);
    ...
    // Title area: full width, title font height
    renderer_->draw_text_centered(PANELS[2].x, PANELS[2].y, PANEL_WIDTH, 32, "Forecast", DisplayRenderer::BLACK);
    // Split remaining area in half
    int remaining_height = PANEL_HEIGHT - 32;
    renderer_->draw_text_centered(PANELS[2].x, PANELS[2].y + 32, PANEL_WIDTH, remaining_height/2, max_str, DisplayRenderer::BLACK);
    renderer_->draw_text_centered(PANELS[2].x, PANELS[2].y + 32 + remaining_height/2, PANEL_WIDTH, remaining_height/2, min_str, DisplayRenderer::BLACK);
    
    // Panel 3: Precipitation chance (single value panel)
    std::string precip_str = std::to_string(data.precipitation_chance_percent) + "%";
    renderer_->draw_text_centered(PANELS[3].x, PANELS[3].y, PANEL_WIDTH, 32, "Precip Chance", DisplayRenderer::BLACK);
    renderer_->draw_text_centered(PANELS[3].x, PANELS[3].y + 32, PANEL_WIDTH, PANEL_HEIGHT - 32, precip_str, DisplayRenderer::BLACK);
    ...
    renderer_->draw_text_centered(PANELS[4].x, PANELS[4].y, PANEL_WIDTH, 32, "Wind", DisplayRenderer::BLACK);
    remaining_height = PANEL_HEIGHT - 32;
    renderer_->draw_text_centered(PANELS[4].x, PANELS[4].y + 32, PANEL_WIDTH, remaining_height/2, wind_speed_str, DisplayRenderer::BLACK);
    renderer_->draw_text_centered(PANELS[4].x, PANELS[4].y + 32 + remaining_height/2, PANEL_WIDTH, remaining_height/2, wind_dir_str, DisplayRenderer::BLACK);
    ...
    renderer_->draw_text_centered(PANELS[5].x, PANELS[5].y, PANEL_WIDTH, 32, "Humidity/Dew", DisplayRenderer::BLACK);
    remaining_height = PANEL_HEIGHT - 32;
    renderer_->draw_text_centered(PANELS[5].x, PANELS[5].y + 32, PANEL_WIDTH, remaining_height/2, humidity_str, DisplayRenderer::BLACK);
    renderer_->draw_text_centered(PANELS[5].x, PANELS[5].y + 32 + remaining_height/2, PANEL_WIDTH, remaining_height/2, dew_str, DisplayRenderer::BLACK);
